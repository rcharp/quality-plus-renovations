  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        >
          I consent to receive marketing text messages from Bush Boys Hauling at the
      ...
      <div className="flex items-start gap-3">
        ...
        <Label
          ...
          className="text-white/70 text-xs leading-relaxed font-normal cursor-pointer"
        >
          I consent to receive non-marketing text messages from Bush Boys Hauling
