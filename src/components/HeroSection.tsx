      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            id="quote-form"
            className="rounded-2xl overflow-hidden shadow-2xl border-2 lg:ml-auto"
            style={{ backgroundColor: "rgba(15, 23, 42, 0.6)", borderColor: "#3b82f6", minHeight: "883px", width: "440px", maxWidth: "100%" }}
          >
            <iframe
