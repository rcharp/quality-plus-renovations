...
const HeroSection = () => {
  ...
  return (
    ...
    <section className="relative overflow-hidden max-w-[100vw]">
      ...
      <div className="container mx-auto px-4 lg:px-8 pt-[200px] sm:pt-[382px] lg:pt-[382px] pb-16 lg:pb-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <QuoteForm id="hero-quote-form" style={{ backgroundColor: "rgba(26, 26, 26, 0.6)", border: "2px solid rgba(26, 26, 26, 0.6)" }} />
          </motion.div>
        </div>
