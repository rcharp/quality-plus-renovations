...
const HeroSection = () => {
  ...
  return (
    ...
    <section className="relative overflow-hidden max-w-[100vw]">
      ...
      <div className="container mx-auto px-4 lg:px-8 <div className="container mx-auto px-4 lg:px-8 pt-24 sm:pt-32 lg:pt-40 pb-16 lg:pb-24 relative z-10"> pb-16 lg:pb-24 relative z-10">
